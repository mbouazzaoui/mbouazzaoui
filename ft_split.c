...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/22 17:13:36 by mbouazza          #+#    #+#             */
/*   Updated: 2021/11/26 22:28:47 by mbouazza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*int main()
{
	char *s = "je sui moussa bouazzoui";
	char	c = 32;
	char	**tab;
	int i;

	//printf(" %d \n %d",nbrstr(s, 32),nbrstr2(s, 32));
	tab = ft_split(s ,c);
	i = 0;
	while (i < ft_nbrstr(s, c))
	{
		printf("%s \n",tab[i]);
		i++;
	}
